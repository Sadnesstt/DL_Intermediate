...
class MyEngine(Engine):
    ...
    def attach(train_engine, validation_engine, verbose = VERBOSE_BATCH_WISE):
        ...
        validation_metric_naems = ['loss', 'accuracy']

        for metric_name in validation_metric_naems:
            attach_running_average(validation_engine, metric_name)

        # Do samethings for validation engine.
        if verbose >= VERBOSE_BATCH_WISE:
            pbar = ProgressBar(bar_format = None, ncols = 120)
            pbar.attach(validation_engine, validation_metric_naems)
...
class Trainer():
    ...
    def train(
        ...
        train_engine.add_event_handler(
            ...
            validation_engine, valid_loader, # arguemnts
        )
        ...
        validation_engine.add_event_handler(
            ...
            train_engine, self.config, # arguemnts
        )
